...
function AllDetails(){
    ...
    return (products?
        ...
        <div className="w-full h-fit bg-red-300 flex flex-col items-center justify-center">
            ...
            {products.map((p,i)=> 
                <div key={i} className=" rounded border border-2 border-black w-[100%] lg:w-[70%] h-fit p-4 bg-red-50 my-4 justify-between flex items-center">
                <h1 className="text-8xl hover:scale-110 mr-4 w-[40%] text-center">{p.character}</h1>
                <div className="w-[70%] ">
